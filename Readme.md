...
```json
{
    ...
    "destination_channel_usernames": [
        "https://t.me/URL_вашого_телеграм_каналу"
    ],
    "source_channel_ids": [
        -1001234567890
    ],
...
- **`destination_channel_usernames`** — Telegram-URL призначення, куди передаватимуться повідомлення.
...
- Для видалення збережених Discord-повідомлень використовуйте кнопку очищення в UI.
